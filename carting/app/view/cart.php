    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2 d-flex justify-content-center">
                        <div>
                            ...
                            <a href="<?php echo INITIAL_RUTE?>cart/deleteItem" type="button" class="btn btn-light"><span class="bi bi-trash"></span></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-end">
          <a href="cart/removeCart" type="buttop" class="btn btn-danger btn-lg me-2">Borrar todo el carrito</a>
